...
//        String str = desObj.strEnc("1111111111111");
...
//    }
     ...
     * @see DESCore
     */
    final static String firstKey="f!@##$%#^$__";
    final static String thirdKey="x10=0088==1";
    final static String secondKey="@@#$!==1";  //
     ...
     */
    public final static List getKeyBytes(String key) {
     ...
     */
    public final static int[] strToBt(String str) {
        int leng = str.length();
        int[] bt = new int[64];
        if (leng < 4) {
            int i = 0, j = 0, p = 0, q = 0;
     ...
     * return hex
     */
    public final static String bt4ToHex(String binary) {
        String hex = "";
     ...
     */
    public final static String hexToBt4(String hex) {
        String binary = "";
    ...
    public final static String bt64ToHex(int[] byteData) {
        String hex = "";
        for (int i = 0; i < 16; i++) {
            String bt = "";
            for (int j = 0; j < 4; j++) {
    ...
    public final static String hexToBt64(String hex) {
        String binary = "";
        for (int i = 0; i < 16; i++) {
    ...
    public final static int[] enc(int[] dataByte, int[] keyByte) {
    ...
    public final static int[] initPermute(int[] originalData) {
    ...
    public final static int[] expandPermute(int[] rightData) {
    ...
    public final static int[] xor(int[] byteOne, int[] byteTwo) {
    ...
    public final static int[] sBoxPermute(int[] expandByte) {
    ...
    public final static int[] pPermute(int[] sBoxByte) {
    ...
    public final static int[] finallyPermute(int[] endByte) {
    ...
    public final static String getBoxBinary(int i) {
        String binary = "";
        switch (i) {
        case 0:
            binary = "0000";
     ...
     * 
     */
    public final static int[][] generateKeys(int[] keyByte) {
        int[] key = new int[56];
