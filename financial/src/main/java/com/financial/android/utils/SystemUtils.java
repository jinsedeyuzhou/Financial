...
public class SystemUtils {
    ...
    public static float obtainDensity() {
        WindowManager wm = (WindowManager) FXApplication.getApp().getSystemService(Context.WINDOW_SERVICE);
        DisplayMetrics outMetrics = new DisplayMetrics();
        wm.getDefaultDisplay().getMetrics(outMetrics);
...
// System.out.println(">>>>>>><<<<<<<" +(String)result);
     ...
     */
    public static String getUUID() {
        TelephonyManager telephonyManager = (TelephonyManager) FXApplication.getApp().getSystemService(Context.TELEPHONY_SERVICE);
        String uuid = Build.PRODUCT + getMacAddress(FXApplication.getApp()) + getDeviceSerial() + Settings.Secure.getString(FXApplication.getApp().getContentResolver(), Settings.Secure.ANDROID_ID);
